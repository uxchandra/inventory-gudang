        ...
        <div class="row">
            <div class="col-12">
                @if (auth()->user()->role->role === 'kepala gudang')
                    ...
                    @else
                        <div class="alert alert-danger d-flex align-items-center" role="alert" style="background-color: #f8d7da; color: #721c24;">
                            <i class="fas fa-info-circle mr-2"></i>
                            Saat ini terdapat {{ $orders->count() }} permintaan barang menunggu konfirmasi. 
                            <a href="{{ route('permintaan-produk.index') }}" class="ml-1" style="color: #0056b3; text-decoration: underline;">Lihat Detail Permintaan</a>
                        </div>
                    @endif
                @elseif (auth()->user()->role->role === 'admin gudang')
                    ...
                    @else
                        <div class="alert alert-warning d-flex align-items-center" role="alert" style="background-color: #f8d7da; color: #000;">
                            <i class="fas fa-info-circle mr-2"></i>
